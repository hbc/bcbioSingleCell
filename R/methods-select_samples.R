...
#'
#' @note Supports an object containing filtered counts generated by [filter()]
#'   on a [bcbioSCDataSet].
#'
...
setMethod("select_samples", "bcbioSCDataSet", function(object) {
    stop(paste("Cellular barcode filtering must be performed",
               "prior to sample selection.",
               "Run `filter()` on the `bcbioRNADataSet` object."))
})
