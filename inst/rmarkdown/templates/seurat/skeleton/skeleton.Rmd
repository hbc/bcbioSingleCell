...
meta.data <- dot_notation(filtered$metrics, rownames = FALSE)
raw.data <- filtered$counts

# Cutoffs
max.genes <- filtered$filter$max_genes
min.genes <- filtered$filter$min_genes
mito.ratio <- filtered$filter$mito_ratio
