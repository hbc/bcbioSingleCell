...
meta.data <- metrics(bcb_filtered) %>% dotted(rownames = FALSE)
raw.data <- counts(bcb_filtered)

# Cutoffs
min.umis <- metadata(filtered)[["filtering_criteria"]][["umis"]]
min.genes <- metadata(filtered)[["filtering_criteria"]][["genes"]]
max.mito.ratio <- metadata(filtered)[["filtering_criteria"]][["mito_ratio"]]
