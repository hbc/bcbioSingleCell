...
# Cutoffs
# FIXME Need to update to S4 slots
max.genes <- bcb_filtered$filter$max_genes
min.genes <- bcb_filtered$filter$min_genes
mito.ratio <- bcb_filtered$filter$mito_ratio
