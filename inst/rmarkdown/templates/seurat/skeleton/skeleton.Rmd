...
```{r seurat}
seurat <- new_seurat(subset, project = params$sample_name)
```
...
```{r save_seurat}
assign(params$sample_name, seurat)
save(list = params$sample_name,
     file = file.path("data", paste0(params$sample_name, ".rda")),
     compress = FALSE)
```
...
```{r save_markers}
markers_name <- paste0(params$sample_name, "_markers")
assign(markers_name, markers)
save(list = markers_name,
     file = file.path("data", paste0(markers_name, ".rda")),
     compress = FALSE)
```
