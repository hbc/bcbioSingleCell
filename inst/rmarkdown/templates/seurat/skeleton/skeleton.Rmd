...
genome_build <- metadata(bcb_filtered)[["genome_build"]]
rm(bcb_filtered)
```
...
# Initialize Seurat (`r sample_name`)
...
```{r save_markers}
assign_data(str_c(sample_name, "_markers"), markers)
dir.create(params$markers_dir,
           recursive = TRUE,
           showWarnings = FALSE)
write_csv(markers,
          file.path(params$markers_dir, str_c(sample_name, ".csv.gz")))
```
