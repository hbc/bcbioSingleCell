...
# Default to using our internal marker tibble managed on Google Sheets.
if (!is.null(params$markersFile)) {
    markers <- readFileByExtension(params$markersFile)
} else {
    ...
    markers <- cellTypeMarkers[[organismShorthand]]
}

# Attempt to load Seurat markers, if already calculated
