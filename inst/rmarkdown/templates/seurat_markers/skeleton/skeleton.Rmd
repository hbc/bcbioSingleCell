...
results_dir <- file.path(params$output_dir, "results", Sys.Date(), "markers")
invisible(mapply(
    FUN = dir.create,
...
assert_is_all_of(seurat, "seurat")
...
if (!is.null(params$cell_type_markers_file)) {
    ...
    cell_type_markers <- readCellTypeMarkersFile(
        params$cell_type_markers_file,
...
assert_is_data.frame(cell_type_markers)
assignAndSaveData(
...
write_csv(
    seurat_all_markers,
    path = file.path(results_dir, paste0(seurat_all_markers_name, ".csv.gz")))
```
