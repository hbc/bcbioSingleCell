...
# This step can a long time to run and shouldn't be cached.
# We recommend running this step outside of R Markdown and then loading the
# presaved R data file instead.
...
```{r top_markers}
top_markers <- topMarkers(all_markers, n = 5, coding = FALSE)
top_markers
```
