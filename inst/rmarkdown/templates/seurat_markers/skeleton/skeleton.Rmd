...
# MAST and DESeq2 are recommended over Wilcoxon rank sum test

library(MAST)
stopifnot(packageVersion("MAST") >= 1.4)

# This step is CPU intensive for large datasets
seurat_all_markers <- FindAllMarkers(
    object = seurat,
    test.use = "MAST",
...
```{r top_markers}
top_markers <- topMarkers(seurat_all_markers, n = 10, coding = FALSE)
top_markers
```
