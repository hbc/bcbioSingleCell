...
params:
    bcbFile: "data/YYYY-MM-DD/bcb_filtered.rda"
    seuratName: "seurat"
    pcCompute: 20
    pcUse: FALSE
...
markersDir <- file.path(params$outputDir, "results", Sys.Date(), "markers")
invisible(mapply(
    list(dataDir, markersDir),
    FUN = dir.create,
...
if (!is.numeric(params$pcUse)) {
    pcUse <- plotPCElbow(seurat, maxPct = 0.05, minCumPct = 0.9)
}
```
