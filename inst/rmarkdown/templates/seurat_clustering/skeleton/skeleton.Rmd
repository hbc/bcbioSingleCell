...
invisible(mapply(
    ...
    MoreArgs = list(
        ...
        col.use = CustomPalette(
            low = viridis(3)[[1]],  # purple
            mid = viridis(3)[[2]],  # green
            high = viridis(3)[[3]]  # yellow
        ),
        do.balanced = TRUE,
        label.columns = FALSE,
        remove.key = TRUE
...
Note that t-SNE/UMAP is not PCA! The measurement of distance in a t-SNE plot is difficult to interpret, and is most helpful for the relationships of close neighbors. To better infer separation distance between the putative clusters, let's reapply PCA.
