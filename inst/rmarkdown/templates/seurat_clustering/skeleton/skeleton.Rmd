...
interestingGroups <- metadata(bcb)$interestingGroups
...
# Initialize Seurat (`r params$bcbName`)
...
seurat <- RunTSNE(
    ...
    dims.use = pcUse,
    do.fast = TRUE)
assignAndSaveData(paste(params$bcbName, "seurat", sep = "_"), seurat)
```
