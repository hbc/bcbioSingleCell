...
Let's convert our `bcbioSCFiltered` class object containing the filtered high-quality cells into a `seurat` class object, without applying any additional cell filtering cutoffs.
