...
assignAndSaveData(seuratPreregressFile, seuratPreregress)
```
...
seurat <- RunTSNE(
    ...
    dims.use = pcUse,
    do.fast = TRUE)
assignAndSaveData(seuratName, seurat)
```
