...
params:
  bcbioSingleCell_file: "data/YYYY-MM-DD/bcb.rds"
  n_cells: !r Inf
  min_umis: 1000
  max_umis: !r Inf
  min_genes: 500
...
```{r object}
object <- readRDS(params$bcbioSingleCell_file)
name <- tools::file_path_sans_ext(basename(params$bcbioSingleCell_file))
...
```{r counts}
# FIXME Switch to using `export()` here instead.
