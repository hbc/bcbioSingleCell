...
plotUMIsPerCell(bcb, geom = "ecdf", point = "inflection")
```
...
```{r filter_cells_by_umi_auto, eval=FALSE, include=FALSE}
# Automatic filtering is disabled by defualt
...
```{r save}
interestingGroups(bcb_filtered) <- interesting_groups
assignAndSaveData(
